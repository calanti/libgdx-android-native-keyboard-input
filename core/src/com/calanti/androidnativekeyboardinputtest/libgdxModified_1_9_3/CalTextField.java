 ...
 *     which then updates the specified focused CalTextField (AndroidKeyboardFeedbackInterface) when text is changed.
 *     The CalTextField also provides feedback to the EditText, such as text selection, cut, paste, etc, to keep content synced.
 *
 *     If AndroidTextInputInterface is null (e.g. from non-Android platform), then *hopefully* default
 *     methods are used instead without problems.
 *
 *  2) Slightly modified ClickListener for usability
 *  3) Better handling of drawing selection and cursorPatch
 *  4) Various other required methods.
 * @author calanti
 * */
...
public class CalTextField extends Widget implements Disableable, AndroidKeyboardFeedbackInterface {
    ...
    /** calanti addition.
     * Requests the Android Keyboard and binds the EditText to this instance. */
    private class AndroidOnscreenKeyboard implements OnscreenKeyboard {
        ...
        public void show(boolean visible) {
            if(visible){
                ...
                updateDisplayText();
            } else androidTextInputInterface.forceHideKeyboard();
        }
    }
    ...
    protected void drawCursor (Drawable cursorPatch, Batch batch, BitmapFont font, float x, float y) {
        ...
        float cx = x + textOffset + glyphPositions.get(cursor) - glyphPositions.get(visibleTextStart) +
                fontOffset + font.getData().cursorX-cursorPatch.getMinWidth()/2;
    ...
    private CalTextField findNextTextField (Array<Actor> actors, CalTextField best, Vector2 bestCoords, Vector2 currentCoords,
                                            boolean up) {
    ...
    /** If false, methods that change the text will not fire {@link ChangeListener.ChangeEvent}, the event will be fired only when user changes
     * the text. */
    ...
    public void setSelection (int selectionStart, int selectionEnd) {
        ...
        if(androidTextInputInterface != null) androidTextInputInterface.setSelection(selectionStart, selectionEnd);
    }
    ...
    public void clearSelection () {
        hasSelection = false;
        /** calanti addition - mimic selection in EditText */
        if(androidTextInputInterface != null) androidTextInputInterface.setSelection(cursor, cursor);
    ...
    public void setCursorPosition (int cursorPosition) {
        ...
        /** calanti addition - mimic selection in EditText */
        if(androidTextInputInterface != null) androidTextInputInterface.setCursorPosition(cursor);
    }
    ...
    /** The default {@link OnscreenKeyboard} used by all {@link CalTextField} instances. Just uses
    ...
    public class TextFieldClickListener extends ClickListener {
        ...
        public void clicked (InputEvent event, float x, float y){
            if(!disabled)
                if(!isFocused()){
                    Stage stage = getStage();
                    if (stage != null) stage.setKeyboardFocus(CalTextField.this);
                    keyboard.show(true);
        ...
        public void touchDragged (InputEvent event, float x, float y, int pointer) {
            ...
            if(!isFocused()) return;
            setCursorPosition(x, y);
            if(androidTextInputInterface != null) androidTextInputInterface.setSelection(selectionStart, cursor);
        }
        ...
        public boolean keyDown (InputEvent event, int keycode) {
            ...
            Stage stage = getStage();
            if (stage == null || stage.getKeyboardFocus() != CalTextField.this) return false;
            ...
            if (UIUtils.shift()) {
                if (keycode == Input.Keys.INSERT) paste(clipboard.getContents(), true);
                if (keycode == Input.Keys.FORWARD_DEL) cut(true);
                selection:
                {
                    int temp = cursor;
                    keys:
        ...
        public boolean keyTyped (InputEvent event, char character) {
            ...
            if ((character == TAB || character == ENTER_ANDROID) && focusTraversal) {
                ...
                if (add || remove) {
                    ...
                    if (add && !remove) {
                        ...
                        if (!enter && filter != null && !filter.acceptChar(CalTextField.this, character)) return true;
            ...
            if (listener != null) listener.keyTyped(CalTextField.this, character);
            return true;
        }
    }
